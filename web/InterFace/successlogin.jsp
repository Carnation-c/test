    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a class="fir"><%=request.getSession().getAttribute("username")%></a></li>
                <li><a>欢迎您</a></li>
                <li>
                    <span></span>
                    <a href="#">消息</a>
...
<div class="jumbotron yy_choice">
    ...
    <a href="/case1_war_exploded/sportappointment.jsp" class="sports"></a>
    <a href="/case1_war_exploded/studyappointment.jsp" class="study"></a>
